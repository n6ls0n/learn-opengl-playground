//  Question: Can you (sort of) re-create the different atmospheres of the last image by tweaking the light's attribute values.
...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("6.desert.multiple_lights.vs", "6.desert.multiple_lights.fs");
    Shader lightCubeShader("6.desert.light_cube.vs", "6.desert.light_cube.fs");
